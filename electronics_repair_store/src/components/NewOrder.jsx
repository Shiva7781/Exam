...
export const NewOrder = () => {
  ...
  return (
    <div>
      <div className="form">
        <input className="new-problem" type="text" name="problem" placeholder="Enter problem" />
        {/* This input is readonly, it's coming from redux */}
        <input className="owner-name" type="text" name="owner_name" placeholder="yourname" readOnly />
        <input className="brand" type="text" name="brand" placeholder="Enter brand name" />
        ...
        <div className="past-orders">
          {userorders.map((el) => {
            if (el.owner_name == user.username) return;
              ...
              return (
                <div>
                  <span className="id">{el.id}</span>. <span className="problem">{el.problem}</span>{" "}
                  <span className="cost">
